...
<!-- Navbar -->
	...
	<nav>
		...
		<h1>Pura Agung Banjarmasin</h1>
		<img src="../img/wisata-religi/pura-agung.jpg" alt="gambar">
		<div style="display: flex;">
   		<div class="container-left">
	   <table border="0,8">
   		<td><font>Pura Agung Jagat Natha Banjarmasin merupakan tempat peribadatan umat umat<br><br>
               Hindu yang terletak di Banjarmasin dan sekitarnya. Terletak di Jl. Gatot<br><br>
               Subroto, Pura Agung ini telah digunakan untuk acara-acara besar umat Hindu<br><br> 
               di Banjarmasin.
